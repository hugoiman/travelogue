    ...
    <ol class="breadcrumb">
        ...
        <form class="form" role="form" method="post" action="" style="margin: 30px 0px 70px -50px;">
            <div class="row" id="kol-tam" style="margin-left: 70px;margin-right: 20px;">
                ...
                <div class="col-md-5" style="margin: 30px 0 10px 50px;">
                    ...
                    <div style="right: : left;margin : 120px 0px 0 415px;">
            ...
            <div class="col-md-4" id="l-post2" style="width: 230px;margin: 20px 20px 0 0; float: right;">
                ...
                <div class="col-md-12">
                    <div class="col-md-9" style="margin-left: -10px;">
                        <label><a href="<?php echo base_url('c_member/profilememberlain'); ?>/<?php echo $isi->id_member; ?>"><?php echo $isi->nama_member ?></a></label>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="col-md-9" style="margin-left: -10px;">
